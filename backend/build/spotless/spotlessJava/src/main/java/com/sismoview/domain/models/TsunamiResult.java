...
public class TsunamiResult {
  ...
  public List<LegendItem> getEtaLegend() {
    return etaLegend;
  }

  public List<LegendItem> getHeightLegend() {
    return heightLegend;
  }
  ...
  public void setEtaLegend(List<LegendItem> l) {
    this.etaLegend = l;
  }

  public void setHeightLegend(List<LegendItem> l) {
    this.heightLegend = l;
  }
}
